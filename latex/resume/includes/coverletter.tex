...
\begin{minipage}{\textwidth}
  ...
  \begin{itemize}[leftmargin=.45in,rightmargin=.45in,itemsep=1.6mm]
	...
	\item Experience analyzing large datasets, from parameter simulation results in MCNP to large clinical MRI imaging cohort studies % large imaging and output datasets
