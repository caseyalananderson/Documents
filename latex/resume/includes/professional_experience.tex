...
\begin{center}
	\begin{minipage}{0.99\textwidth}
		\begin{center}
			\textsc{\Large Performing tasks related to the development, design, implementation, testing, and validation of multiple computational physics projects} \vspace{2mm}
		\end{center}
	\end{minipage}
\end{center}
\begin{minipage}{\textwidth}
