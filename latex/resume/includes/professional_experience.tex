...
\begin{center}
	\begin{minipage}{0.95\textwidth}
		\textsc{\Large Performing tasks related to the development, design, implementation, testing, validation, and verification of a variety of computational physics projects including:} \vspace{2mm}
	\end{minipage}
\end{center}
\begin{minipage}{\textwidth}
	\begin{center}
		% \begin{itemize}
			...
			\begin{itemize}
				...
				% of a visualization package for finite element geometries in MCNP simulations.
				%\item A health and medical physics application of computation
				\item Utilizing LANL's high performance computing (HPC) for physics simulations and analysis.
...
\begin{center}
	\begin{minipage}{0.98\textwidth}
		\textsc{\Large Conducted research and tasks towards pursuit a Master's Thesis such as:} \vspace{2mm}
	\end{minipage}
\end{center}
...
\begin{minipage}{\textwidth}
	...
	\begin{center}
		...
		\begin{itemize}
			...
			\item Analyzing and processing large imaging datasets, seeking trends for clinical application %MRI d searching for clinically viable clinical imaging for detecting clinical applications
...
\begin{center}
	\begin{minipage}{0.98\textwidth}
		\textsc{\Large Attended classes, assisted with research, and contributed to organizational duties such as:} \vspace{2mm}
	\end{minipage}
\end{center}
...
\begin{minipage}{\textwidth}
	...
	\begin{itemize}
		...
		\item Managing the American Nuclear Society (ANS) organizational duties as student chaper president %, including activities such as recruiting guest speakers to present at meetings, organizing conference travel, and arranging public outreach events.
		\item Mentoring and teaching undergraduates and K-12 students students through a variety of ANS outreach events %such as through volunteering at various events, such as Science Olympiad, middle and high school science fairs, and local Boy Scout chapters on achieving their Nuclear Science Merit Badge.
	\end{itemize}
	\end{center}
\end{minipage}
