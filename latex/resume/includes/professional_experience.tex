...
\begin{minipage}{\textwidth}
	\begin{center}
		\begin{itemize}
			...
			\item Developer of \textsc{MCNP}, the Common Modelling Framework (\textsc{CMF}), and the Nuclear Detection Figure of Merit (\textsc{NDFOM}) project, implementing features such as: \vspace{2mm}
			\begin{itemize}
